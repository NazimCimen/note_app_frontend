...
import 'package:flutter_note_app/presentation/auth/mixin/signup_mixin.dart';
    ...
    return BlocConsumer<AuthCubit, AuthState>(
      listener: (context, state) {
        ...
        if (state is AuthSuccess) {
          CustomSnackBar.showSuccess(context, StringConstants.signupSuccess);
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Header(
                                    ...
                                    subtitle:
                                        StringConstants.authSignupSubtitle,
                                  ),
